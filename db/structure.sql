...
--
ALTER TABLE
    ONLY public.stage_connections
ADD
    CONSTRAINT stage_connections_pkey PRIMARY KEY (id);
...
ALTER TABLE
    ONLY public.stage_connections
ADD
    CONSTRAINT stage_connections_stage_id_source_id_key UNIQUE (stage_id, source_id);

--
-- Name: stage_event_approvals stage_event_approvals_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public.stage_event_approvals
ADD
    CONSTRAINT stage_event_approvals_pkey PRIMARY KEY (id);
...
ALTER TABLE
    ONLY public.stage_event_approvals
ADD
    CONSTRAINT stage_event_approvals_stage_event_id_approved_by_key UNIQUE (stage_event_id, approved_by);

--
-- Name: stage_events stage_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public.stage_events
ADD
...
ALTER TABLE
    ONLY public.event_sources
ADD
    CONSTRAINT event_sources_canvas_id_fkey FOREIGN KEY (canvas_id) REFERENCES public.canvases(id);
...
ALTER TABLE
    ONLY public.stage_connections
ADD
    CONSTRAINT stage_connections_stage_id_fkey FOREIGN KEY (stage_id) REFERENCES public.stages(id);
...
ALTER TABLE
    ONLY public.stage_event_approvals
ADD
    CONSTRAINT stage_event_approvals_stage_event_id_fkey FOREIGN KEY (stage_event_id) REFERENCES public.stage_events(id);
...
ALTER TABLE
    ONLY public.stage_events
ADD
    CONSTRAINT stage_events_stage_id_fkey FOREIGN KEY (stage_id) REFERENCES public.stages(id);
...
ALTER TABLE
    ONLY public.stage_executions
ADD
    CONSTRAINT stage_executions_stage_event_id_fkey FOREIGN KEY (stage_event_id) REFERENCES public.stage_events(id);
...
ALTER TABLE
    ONLY public.stage_executions
ADD
    CONSTRAINT stage_executions_stage_id_fkey FOREIGN KEY (stage_id) REFERENCES public.stages(id);
...
ALTER TABLE
    ONLY public.stages
ADD
    CONSTRAINT stages_canvas_id_fkey FOREIGN KEY (canvas_id) REFERENCES public.canvases(id);
...
--
COPY public.schema_migrations (version, dirty)
FROM
    stdin;
