...
const (
	...
	Superplane_ListTags_FullMethodName            = "/Superplane.Superplane/ListTags"
	Superplane_UpdateTagState_FullMethodName      = "/Superplane.Superplane/UpdateTagState"
)
...
func (c *superplaneClient) ListTags(ctx context.Context, in *ListTagsRequest, opts ...grpc.CallOption) (*ListTagsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListTagsResponse)
	err := c.cc.Invoke(ctx, Superplane_ListTags_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *superplaneClient) UpdateTagState(ctx context.Context, in *UpdateTagStateRequest, opts ...grpc.CallOption) (*UpdateTagStateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateTagStateResponse)
	err := c.cc.Invoke(ctx, Superplane_UpdateTagState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSuperplaneServer) ListTags(context.Context, *ListTagsRequest) (*ListTagsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListTags not implemented")
}
func (UnimplementedSuperplaneServer) UpdateTagState(context.Context, *UpdateTagStateRequest) (*UpdateTagStateResponse, error) {
...
func _Superplane_ListTags_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListTagsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SuperplaneServer).ListTags(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Superplane_ListTags_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SuperplaneServer).ListTags(ctx, req.(*ListTagsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Superplane_UpdateTagState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateTagStateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SuperplaneServer).UpdateTagState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Superplane_UpdateTagState_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SuperplaneServer).UpdateTagState(ctx, req.(*UpdateTagStateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Superplane_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListTags",
			Handler:    _Superplane_ListTags_Handler,
		},
		{
			MethodName: "UpdateTagState",
			Handler:    _Superplane_UpdateTagState_Handler,
		},
	},
